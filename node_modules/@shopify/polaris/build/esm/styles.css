@charset "UTF-8";
:root { --polaris-version-number: '9.6.0'; }
...
.Polaris-Avatar { --pc-avatar-extra-small-size: 1.5rem; --pc-avatar-small-size: 2rem; --pc-avatar-medium-size: 2.5rem; --pc-avatar-large-size: 3.75rem; position: relative; display: block; overflow: hidden; min-width: var(--pc-avatar-extra-small-size); max-width: 100%; background: var(--p-surface-neutral); color: var(--p-icon-subdued); border-radius: var(--p-border-radius-half); -webkit-user-select: none; user-select: none; }
...
.Polaris-Avatar__Image { position: absolute; top: 50%; left: 50%; width: 100%; height: 100%; background-color: var(--p-background); border-radius: var(--p-border-radius-half); transform: translate(-50%, -50%); object-fit: cover; }
...
.Polaris-VisuallyHidden { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Popover__Wrapper { position: relative; overflow: hidden; background-color: var(--p-surface); border-radius: var(--p-border-radius-2); outline: 0.0625rem solid transparent; }
...
.Polaris-Popover__FocusTracker { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Badge--sizeSmall { font-size: var(--p-font-size-1); }
...
.Polaris-Badge-Pip--statusInfo { --pc-pip-color: var(--p-icon); }
...
.Polaris-TextStyle--variationCode { position: relative; padding: 0 var(--p-space-1); border-radius: var(--p-border-radius-base); background-color: var(--p-surface-subdued); display: inline-block; font-size: var(--p-font-size-5); box-shadow: inset 0 0 0 0.0625rem var(--p-border-subdued); }
...
.Polaris-ActionList { --pc-action-list-image-size: 1.25rem; --pc-action-list-item-min-height: var(--p-space-10); --pc-action-list-item-vertical-padding: calc((var(--pc-action-list-item-min-height) - var(--p-line-height-2))/2); outline: none; list-style: none; margin: 0; padding: 0; }
...
.Polaris-ActionList__Title { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; padding: var(--p-space-1) var(--p-space-4) var(--p-space-3) var(--p-space-4); }

@media (min-width: 40em) { .Polaris-ActionList__Title { font-size: var(--p-font-size-1); } }

.Polaris-ActionList__Title.Polaris-ActionList--firstSectionWithTitle { padding-top: var(--p-space-3); }
...
.Polaris-Button { --pc-button-slim-min-height: var(--p-line-height-4); --pc-button-large-min-height: var(--p-line-height-7); --pc-button-vertical-padding: calc((var(--p-line-height-6) - var(--p-line-height-2) - var(--p-space-05))/2); --pc-button-slim-vertical-padding: calc((var(--pc-button-slim-min-height) - var(--p-line-height-2) - var(--p-space-05))/2); --pc-button-large-vertical-padding: calc((var(--pc-button-large-min-height) - var(--p-line-height-2) - var(--p-space-05))/2); --pc-button-spinner-size: 1.25rem; --pc-button-segment: 10; --pc-button-focused: 20; position: relative; position: relative; display: inline-flex; align-items: center; justify-content: center; min-height: var(--p-line-height-6); min-width: var(--p-line-height-6); margin: 0; padding: calc((var(--p-line-height-6) - var(--p-line-height-2) - var(--p-space-05))/2) var(--p-space-4); background: var(--p-surface); box-shadow: var(--p-shadow-button); border-radius: var(--p-border-radius-1); color: var(--p-text); border: 0.0625rem solid var(--p-border-neutral-subdued); border-top-color: var(--p-border-subdued); border-bottom-color: var(--p-border-shadow-subdued); line-height: 1; text-align: center; cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; -webkit-tap-highlight-color: transparent; }
...
.Polaris-Button__Content { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-medium); line-height: var(--p-line-height-1); text-transform: initial; letter-spacing: initial; position: relative; display: flex; justify-content: center; align-items: center; min-width: 0.0625rem; min-height: 0.0625rem; }

@media (min-width: 40em) { .Polaris-Button__Content { font-size: var(--p-font-size-3); } }
...
.Polaris-Button__Icon:last-child { margin-right: calc((var(--p-space-2))*-1); margin-left: var(--p-space-1); }
...
.Polaris-Button--outline.Polaris-Button--destructive.Polaris-Button--pressed { background: var(--p-surface-critical-subdued); box-shadow: var(--p-border-width-1) solid var(--p-border-critical); color: var(--p-interactive-critical); }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--destructive.Polaris-Button--pressed { background: var(--p-surface-critical-subdued); box-shadow: var(--p-border-width-1) solid var(--p-border-critical); color: var(--p-interactive-critical); }
...
.Polaris-Button--plain.Polaris-Button--iconOnly { margin: calc((var(--p-line-height-6) - var(--p-icon-size-medium))*-0.5); }
...
.Polaris-Button--sizeLarge .Polaris-Button__Content { font-size: var(--p-font-size-6); font-weight: var(--p-font-weight-medium); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; }

@media (min-width: 40em) { .Polaris-Button--sizeLarge .Polaris-Button__Content { font-size: var(--p-font-size-5); } }
...
.Polaris-Button--monochrome.Polaris-Button--outline::after { content: ''; position: absolute; z-index: 1; top: calc(var(--p-border-width-2)*-1 + -0.0625rem); right: calc(var(--p-border-width-2)*-1 + -0.0625rem); bottom: calc(var(--p-border-width-2)*-1 + -0.0625rem); left: calc(var(--p-border-width-2)*-1 + -0.0625rem); display: block; pointer-events: none; box-shadow: 0 0 0 calc(var(--p-border-width-2)*-1 + -0.0625rem) var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: calc(var(--p-border-radius-1) + 0.0625rem); }
...
.Polaris-Button__ConnectedDisclosure { z-index: var(--pc-button-segment); margin-left: calc(var(--p-border-width-1)*-1); border-top-left-radius: 0; border-bottom-left-radius: 0; height: 100%; }
...
.Polaris-ButtonGroup--segmented .Polaris-ButtonGroup__Item:not(:first-child) { margin-left: calc(var(--p-border-width-1)*-1); }
...
.Polaris-Heading { font-size: var(--p-font-size-6); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-3); margin: 0; }

@media (min-width: 40em) { .Polaris-Heading { font-size: var(--p-font-size-5); } }

@media print { .Polaris-Heading { font-size: var(--p-font-size-3); line-height: var(--p-line-height-1); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card { border-radius: var(--p-border-radius-2); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Header { padding: var(--p-space-5) var(--p-space-5) 0; } }

@media (min-width: 30.625em) { .Polaris-Card__Header { padding: var(--p-space-5) var(--p-space-5) 0; } }

@media print and (max-width: 48.0625em) and (min-width: 30.625em), print and (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Header { padding: var(--p-space-2) var(--p-space-4) var(--p-space-0); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Section { padding: var(--p-space-5); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Section--fullWidth { padding: var(--p-space-5) var(--p-space-0); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Section--flush { padding: var(--p-space-0); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Section--fullWidth .Polaris-Card__SectionHeader { padding-left: var(--p-space-5); padding-right: var(--p-space-5); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Card__Footer { padding: 0 var(--p-space-5) var(--p-space-5); } }
...
.Polaris-Subheading { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; margin: 0; }

@media (min-width: 40em) { .Polaris-Subheading { font-size: var(--p-font-size-1); } }

@media print { .Polaris-Subheading { font-size: var(--p-font-size-1); } }
...
.Polaris-ActionMenu-RollupActions__RollupActivator button[type='button'] { margin: 0; border: 0.0625rem solid var(--p-border-neutral-subdued); }

.Polaris-ActionMenu-RollupActions__RollupActivator button[type='button']:hover, .Polaris-ActionMenu-RollupActions__RollupActivator button[type='button']:active, .Polaris-ActionMenu-RollupActions__RollupActivator button[type='button']:focus { border: 0.0625rem solid var(--p-border-neutral-subdued); }
...
.Polaris-Label--hidden { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }

.Polaris-Label__Text { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; display: block; flex: 1 1 auto; color: currentColor; -webkit-tap-highlight-color: transparent; }

@media (min-width: 40em) { .Polaris-Label__Text { font-size: var(--p-font-size-3); } }
...
.Polaris-Labelled--hidden > .Polaris-Labelled__LabelWrapper { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Labelled__HelpText { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; color: var(--p-text-subdued); word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; margin-top: var(--p-space-1); }

@media (min-width: 40em) { .Polaris-Labelled__HelpText { font-size: var(--p-font-size-3); } }
...
.Polaris-TextField { --pc-text-field-contents: 20; --pc-text-field-backdrop: 10; font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); border: none; text-transform: initial; letter-spacing: initial; position: relative; display: flex; align-items: center; color: var(--p-text); cursor: text; }

@media (min-width: 40em) { .Polaris-TextField { font-size: var(--p-font-size-3); } }
...
.Polaris-TextField__Backdrop { position: relative; position: absolute; z-index: var(--pc-text-field-backdrop); top: 0; right: 0; bottom: 0; left: 0; background-color: var(--p-surface); border: 0.0625rem solid var(--p-border-subdued); border-top-color: var(--p-border-shadow); border-radius: var(--p-border-radius-1); pointer-events: none; }
...
.Polaris-TextField__VerticalContent { position: relative; z-index: var(--pc-text-field-contents); color: var(--p-text-subdued); -webkit-user-select: none; user-select: none; padding: var(--p-space-2) var(--p-space-2) 0 var(--p-space-2); max-height: 8.75rem; overflow: scroll; border: var(--p-border-transparent); width: 100%; }
...
.Polaris-Choice--labelHidden > .Polaris-Choice__Label { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Choice__Control { display: flex; flex: 0 0 auto; align-items: stretch; width: var(--p-choice-size); height: var(--p-choice-size); margin-right: var(--p-space-2); }

.Polaris-Choice__Control > * { width: 100%; }

.Polaris-Choice__Label { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; -webkit-tap-highlight-color: transparent; }

@media (min-width: 40em) { .Polaris-Choice__Label { font-size: var(--p-font-size-3); } }

.Polaris-Choice__Label:hover { cursor: pointer; }

.Polaris-Choice__Descriptions { padding-left: calc(var(--p-space-2) + var(--p-choice-size)); }

.Polaris-Choice__HelpText { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; color: var(--p-text-subdued); margin-bottom: var(--p-space-1); }

@media (min-width: 40em) { .Polaris-Choice__HelpText { font-size: var(--p-font-size-3); } }


.Polaris-Checkbox { position: relative; margin: var(--p-choice-margin); }

.Polaris-Checkbox__Input { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Listbox-Header { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; padding: var(--p-space-2) var(--p-space-4); color: var(--p-text-subdued); }

@media (min-width: 40em) { .Polaris-Listbox-Header { font-size: var(--p-font-size-1); } }
...
.Polaris-Autocomplete-MappedAction__ActionContainer { --pc-mapped-actions-image-size: 1.25rem; --pc-mapped-actions-item-min-height: var(--p-space-10); --pc-mapped-actions-item-vertical-padding: calc((var(--pc-mapped-actions-item-min-height) - var(--p-line-height-2))/2); margin-bottom: var(--p-space-3); }
...
.Polaris-Autocomplete-MappedAction__Action { position: relative; display: block; width: 100%; min-height: var(--pc-mapped-actions-item-min-height); text-align: left; cursor: pointer; padding: var(--pc-mapped-actions-item-vertical-padding) var(--p-space-2); border-radius: var(--p-border-radius-1); border-top: 0.0625rem solid var(--p-surface); }
...
@media (-ms-high-contrast: active) { .Polaris-Autocomplete-MappedAction__Action:hover { outline: 0.0625rem solid windowText; } }
...
.Polaris-Banner { --pc-banner-secondary-action-horizontal-padding: var(--p-space-3); --pc-banner-secondary-action-vertical-padding: calc((var(--p-line-height-6) - var(--p-line-height-2))*0.5); position: relative; display: flex; }
...
.Polaris-Banner__SecondaryAction:focus > .Polaris-Banner__Text { padding: var(--p-space-05) 0.3125rem; margin: calc(var(--p-space-05)*-1) -0.3125rem; background: var(--p-action-secondary-hovered); border-radius: var(--p-border-radius-base); box-shadow: none; background-color: transparent; text-decoration: underline; }

@media (-ms-high-contrast: active) { .Polaris-Banner__SecondaryAction:focus > .Polaris-Banner__Text { outline: 0.125rem dotted; } }
...
@media (-ms-high-contrast: active) { .Polaris-Banner__Button { border: 0.0625rem solid windowText; } }

@media (min-width: 40em) { .Polaris-Banner__Button { font-size: var(--p-font-size-3); } }
...
.Polaris-CheckableButton { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-medium); line-height: var(--p-line-height-1); text-transform: initial; letter-spacing: initial; display: flex; align-items: center; min-height: var(--p-line-height-6); min-width: var(--p-line-height-6); margin: 0; padding: calc((var(--p-line-height-6) - var(--p-line-height-2) - var(--p-space-05))/2) var(--p-space-4); line-height: 1; cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; text-align: left; border-radius: var(--p-border-radius-1); width: 100%; background: var(--p-surface); box-shadow: var(--p-shadow-button); border: 0.0625rem solid var(--p-border-neutral-subdued); border-top-color: var(--p-border-subdued); border-bottom-color: var(--p-border-shadow-subdued); }

@media (min-width: 40em) { .Polaris-CheckableButton { font-size: var(--p-font-size-3); } }
...
.Polaris-CheckableButton.Polaris-CheckableButton__CheckableButton--measuring { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-bold); }

.Polaris-CheckableButton.Polaris-CheckableButton__CheckableButton--measuring::before { content: ''; display: inline-block; width: var(--p-font-size-4); }
...
.Polaris-CheckableButton__Checkbox { pointer-events: none; height: var(--p-choice-size); width: var(--p-choice-size); margin-left: calc((var(--p-space-2) + var(--p-space-025))*-1 - var(--p-control-border-width)); }
...
.Polaris-BulkActions__Group { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); border: none; text-transform: initial; letter-spacing: initial; width: 100%; display: none; align-items: center; flex-wrap: wrap; opacity: 0; }

@media (min-width: 40em) { .Polaris-BulkActions__Group { font-size: var(--p-font-size-3); } }
...
@media (min-width: 28.625em) { .Polaris-BulkActions__ButtonGroupWrapper { width: auto; justify-content: flex-start; margin-right: var(--p-space-2); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-CalloutCard__Image { display: block; margin-left: var(--p-space-5); } }
...
.Polaris-Caption { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); margin: 0; }

@media (min-width: 40em) { .Polaris-Caption { font-size: var(--p-font-size-1); line-height: var(--p-line-height-1); } }


.Polaris-RadioButton { position: relative; margin: var(--p-choice-margin); }

.Polaris-RadioButton__Input { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-RadioButton__Backdrop { position: relative; top: 0; left: 0; display: block; width: 100%; height: 100%; border: var(--p-control-border-width) solid var(--p-border); border-radius: var(--p-border-radius-half); background-color: var(--p-surface); transition: border-color var(--p-duration-100) var(--p-ease); position: relative; }
...
@media (forced-colors: active) { .Polaris-RadioButton__Backdrop::before { border: 0.3125rem solid transparent; } }
...
.Polaris-ChoiceList--titleHidden > .Polaris-ChoiceList__Title { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-ChoiceList__Title { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; display: block; margin: 0 0 var(--p-space-1); padding: 0; }

@media (min-width: 40em) { .Polaris-ChoiceList__Title { font-size: var(--p-font-size-3); } }
...
@media (-ms-high-contrast: active) { .Polaris-ColorPicker__MainColor { outline: 0.0625rem solid windowText; } }
...
@media (-ms-high-contrast: active) { .Polaris-ColorPicker__HuePicker, .Polaris-ColorPicker__AlphaPicker { outline: 0.0625rem solid windowText; } }
...
.Polaris-DataTable { --pc-data-table-first-column-width: 9.0625rem; position: relative; max-width: 100vw; }

.Polaris-DataTable--condensed .Polaris-DataTable__Navigation { display: flex; align-items: center; justify-content: center; width: 100%; padding: var(--p-space-4) var(--p-space-2); }
...
.Polaris-DataTable__ScrollContainer { overflow-x: auto; -webkit-overflow-scrolling: touch; scroll-behavior: smooth; }
...
.Polaris-DataTable__Cell { padding: var(--p-space-4); white-space: nowrap; text-align: left; transition: background-color var(--p-duration-200) var(--p-ease-in-out); }
...
.Polaris-DataTable__Cell--firstColumn { font-weight: var(--p-font-weight-regular); color: var(--p-text); text-align: left; white-space: normal; }
...
.Polaris-DataTable__IncreasedTableDensity .Polaris-DataTable__Cell--header { font-weight: var(--p-font-weight-medium); font-size: var(--p-font-size-1); }
...
.Polaris-DataTable__IncreasedTableDensity .Polaris-DataTable__Cell--sortable:first-child button { padding-right: 0; padding-left: var(--p-space-1); }
...
.Polaris-DataTable__Icon { display: flex; align-self: flex-end; opacity: 0; transition: opacity var(--p-duration-200) var(--p-ease), fill var(--p-duration-200) var(--p-ease); }
...
.Polaris-DataTable__IncreasedTableDensity .Polaris-DataTable__Heading { font-weight: var(--p-font-weight-medium); font-size: var(--p-font-size-1); padding: 0; padding-right: var(--p-space-1); margin: 0; }
...
.Polaris-DataTable__Heading:hover .Polaris-DataTable__Icon svg { fill: var(--p-icon-disabled); }
...
.Polaris-DatePicker__Day { display: block; height: 100%; width: 100%; margin: 0; padding: var(--p-space-2); background: transparent; border: none; border-radius: var(--p-border-radius-1); outline: none; font-size: var(--p-font-size-1); text-align: center; color: var(--p-text); cursor: pointer; position: relative; }
...
@media (-ms-high-contrast: active) { .Polaris-DatePicker__Day--inRange { -ms-high-contrast-adjust: none; background-color: Highlight; color: HighlightText; }
  .Polaris-DatePicker__Day--inRange:hover { background-color: HighlightText; color: Highlight; outline: 0.125rem solid Highlight; } }
...
@media (-ms-high-contrast: active) { .Polaris-DatePicker__Day--selected { -ms-high-contrast-adjust: none; background-color: Highlight; color: HighlightText; }
  .Polaris-DatePicker__Day--selected:hover { background-color: HighlightText; color: Highlight; outline: 0.125rem solid Highlight; } }
...
.Polaris-DatePicker__Weekday { padding: var(--p-space-2); background: transparent; font-size: var(--p-font-size-1); font-weight: var(--p-font-weight-regular); color: var(--p-text-subdued); text-align: center; }
...
@media (max-width: 48.0625em) and (min-width: 36.875em), (min-width: 51.875em) { [data-has-navigation] .Polaris-DescriptionList__Term { flex: 0 1 25%; padding: var(--p-space-4) var(--p-space-4) var(--p-space-4) 0; }
  .Polaris-DescriptionList--spacingTight [data-has-navigation] .Polaris-DescriptionList__Term { padding: var(--p-space-2) var(--p-space-2) var(--p-space-2) 0; }
  .Polaris-DescriptionList__Description + [data-has-navigation] .Polaris-DescriptionList__Term + .Polaris-DescriptionList__Description { border-top: var(--p-border-divider); } }

@media (min-width: 36.875em) { .Polaris-DescriptionList__Term { flex: 0 1 25%; padding: var(--p-space-4) var(--p-space-4) var(--p-space-4) 0; }
...
@media (max-width: 48.0625em) and (min-width: 36.875em), (min-width: 51.875em) { [data-has-navigation] .Polaris-DescriptionList__Description { flex: 1 1 51%; padding: var(--p-space-4) 0; }
  .Polaris-DescriptionList--spacingTight [data-has-navigation] .Polaris-DescriptionList__Description { padding: var(--p-space-2) 0; }
  [data-has-navigation] .Polaris-DescriptionList__Description + .Polaris-DescriptionList__Term + .Polaris-DescriptionList__Description { border-top: var(--p-border-divider); } }

@media (min-width: 36.875em) { .Polaris-DescriptionList__Description { flex: 1 1 51%; padding: var(--p-space-4) 0; }
...
.Polaris-DisplayText--sizeSmall { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); }

@media (min-width: 40em) { .Polaris-DisplayText--sizeSmall { font-size: var(--p-font-size-7); line-height: var(--p-line-height-4); } }

.Polaris-DisplayText--sizeMedium { font-size: var(--p-font-size-8); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-4); }

@media (min-width: 40em) { .Polaris-DisplayText--sizeMedium { font-size: var(--p-font-size-10); line-height: var(--p-line-height-5); } }

.Polaris-DisplayText--sizeLarge { font-size: var(--p-font-size-9); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-4); }

@media (min-width: 40em) { .Polaris-DisplayText--sizeLarge { font-size: var(--p-font-size-12); line-height: var(--p-line-height-5); } }

.Polaris-DisplayText--sizeExtraLarge { font-size: var(--p-font-size-11); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-6); }

@media (min-width: 40em) { .Polaris-DisplayText--sizeExtraLarge { font-size: var(--p-font-size-13); line-height: var(--p-line-height-7); } }
...
.Polaris-DropZone--hasOutline { padding: var(--p-border-width-1); }
...
.Polaris-DropZone--hasOutline:not(.Polaris-DropZone--focused)::after { top: 0; left: 0; right: 0; bottom: 0; opacity: 1; transform: scale(1); border: var(--p-border-width-1) dashed transparent; border-radius: calc(var(--p-border-radius-1) + var(--p-border-width-1) + 0.0625rem); border-color: var(--p-border-neutral-subdued); }
...
.Polaris-DropZone__Overlay { border-radius: calc(var(--p-border-radius-1) + var(--p-border-width-1) + 0.0625rem); position: absolute; z-index: var(--pc-drop-zone-overlay); top: 0; right: 0; bottom: 0; left: 0; display: flex; justify-content: center; align-items: center; padding: var(--p-space-4); border: var(--p-border-width-1) dashed var(--p-interactive); text-align: center; color: var(--p-interactive); background-color: var(--p-surface-selected); pointer-events: none; }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-EmptyState__Section { left: var(--p-space-5); } }

@media (min-width: 46.5em) { .Polaris-EmptyState__Section { left: var(--p-space-5); } }

.Polaris-EmptyState__Details { display: flex; text-align: center; flex-direction: column; align-items: center; }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-EmptyState__Details { max-width: 25rem; } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-EmptyState--withinContentContainer .Polaris-EmptyState__Details { max-width: 25rem; } }
...
.Polaris-EmptyState--withinContentContainer .Polaris-EmptyState__Content { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; padding-bottom: var(--p-space-2); }

@media (min-width: 40em) { .Polaris-EmptyState--withinContentContainer .Polaris-EmptyState__Content { font-size: var(--p-font-size-3); } }
...
.Polaris-EmptyState__Content { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; color: var(--p-text-subdued); padding-bottom: var(--p-space-2); }

@media (min-width: 40em) { .Polaris-EmptyState__Content { font-size: var(--p-font-size-3); } }
...
.Polaris-Tag.Polaris-Tag--clickable { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; cursor: pointer; padding: var(--p-space-1) var(--p-space-2); background-color: var(--p-surface-neutral); outline: var(--p-border-width-1) solid transparent; font-size: var(--p-font-size-2); line-height: var(--p-line-height-2); position: relative; }
...
@media (min-width: 30.625em) { .Polaris-Tag.Polaris-Tag--clickable { padding: var(--p-space-05) var(--p-space-2); font-size: var(--p-font-size-1); } }
...
.Polaris-Tag__TagText { font-size: var(--p-font-size-2); line-height: var(--p-line-height-2); min-height: 1.25rem; padding: var(--p-space-1) 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; vertical-align: middle; }

@media (min-width: 30.625em) { .Polaris-Tag__TagText { font-size: var(--p-font-size-1); padding: var(--p-space-05) 0; } }
...
.Polaris-Tag__Link .Polaris-Tag__LinkText { overflow: hidden; white-space: nowrap; text-overflow: ellipsis; font-size: var(--p-font-size-2); line-height: var(--p-line-height-2); padding-top: var(--p-space-1); padding-bottom: var(--p-space-1); }

@media (min-width: 30.625em) { .Polaris-Tag__Link .Polaris-Tag__LinkText { font-size: var(--p-font-size-1); padding-top: var(--p-space-05); padding-bottom: var(--p-space-05); } }
...
@media (min-width: 48.0625em) { .Polaris-Sheet { right: 0; width: 23.75rem; } }

.Polaris-Sheet:focus { outline: 0; }

.Polaris-Sheet__Container { position: fixed; z-index: var(--p-z-11); top: 0; right: 0; bottom: 0; left: 0; }

@media (min-width: 48.0625em) { .Polaris-Sheet__Container { left: auto; width: 23.75rem; } }
...
.Polaris-Filters__FilterTriggerTitle { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-semibold); }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-FooterHelp { margin: var(--p-space-5); width: auto; } }

@media (min-width: 30.625em) { .Polaris-FooterHelp { margin: var(--p-space-5); width: auto; } }

.Polaris-FooterHelp__Text { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); border: none; text-transform: initial; letter-spacing: initial; }

@media (min-width: 40em) { .Polaris-FooterHelp__Text { font-size: var(--p-font-size-3); } }
...
.Polaris-Frame-Toast { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); display: inline-flex; max-width: 31.25rem; padding: var(--p-space-2) var(--p-space-4); border-radius: var(--p-border-radius-2); background: var(--p-surface); color: var(--p-text); margin-bottom: var(--p-space-5); }

@media (min-width: 40em) { .Polaris-Frame-Toast { font-size: var(--p-font-size-7); line-height: var(--p-line-height-4); } }

@media (min-width: 40em) { .Polaris-Frame-Toast { padding: var(--p-space-4); } }
...
@media (min-width: 40em) { .Polaris-Frame-Toast__CloseButton { align-self: flex-start; margin: calc(var(--p-space-2)*-1) calc(var(--p-space-4)*-1) calc(var(--p-space-2)*-1) 0; padding: var(--p-space-3) var(--p-space-4) var(--p-space-2); } }
...
.Polaris-Modal-Dialog__Container { position: fixed; z-index: var(--p-z-11); top: 0; right: 0; bottom: 0; left: 0; display: flex; flex-direction: column; justify-content: flex-end; }

@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Container { justify-content: center; } }

.Polaris-Modal-Dialog:focus { outline: 0; }

.Polaris-Modal-Dialog__Modal { --pc-dialog-horizontal-spacing: var(--p-space-16); position: fixed; right: 0; bottom: 0; left: 0; display: flex; flex-direction: column; width: 100%; max-height: calc(100vh - 3.75rem); background: var(--p-surface); box-shadow: var(--p-shadow-modal); }
...
@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal { position: relative; max-width: 38.75rem; margin: 0 auto; border-radius: var(--p-border-radius-2); } }

@media (min-width: 48.0625em) and (min-height: 660px) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--limitHeight { max-height: 37.5rem; } }

@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeSmall { max-width: calc(100% - var(--pc-dialog-horizontal-spacing)); } }

@media (min-width: 27.75em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeSmall { max-width: 23.75rem; } }

@media (min-width: 48.0625em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeLarge { max-width: calc(100% - var(--pc-dialog-horizontal-spacing)); } }

@media (min-width: 65.25em) { .Polaris-Modal-Dialog__Modal.Polaris-Modal-Dialog--sizeLarge { max-width: 61.25rem; } }
...
.Polaris-Modal-Header--titleHidden { position: absolute; right: var(--p-space-2); z-index: 1; }
...
@media (min-width: 48.0625em) { .Polaris-Modal__IFrame { max-width: 38.75rem; } }

.Polaris-Modal__Spinner { margin: var(--p-space-4); text-align: center; }


.Polaris-Frame-ContextualSaveBar { display: flex; height: 3.5rem; background: var(--p-surface); box-shadow: 0 0.125rem 0.25rem var(--p-hint-from-direct-light); }
...
@media (min-width: 48.0625em) { .Polaris-Frame-ContextualSaveBar__LogoContainer { display: flex; flex: 0 0 15rem; align-items: center; height: 100%; padding: 0 var(--p-space-4); background-color: transparent; } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Frame-ContextualSaveBar__Contents { padding: 0 var(--p-space-5); } }

@media (min-width: 30.625em) { .Polaris-Frame-ContextualSaveBar__Contents { padding: 0 var(--p-space-5); } }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-Frame-ContextualSaveBar__Contents { padding: 0 var(--p-space-8); } }

@media (min-width: 46.5em) { .Polaris-Frame-ContextualSaveBar__Contents { padding: 0 var(--p-space-8); } }

.Polaris-Frame-ContextualSaveBar--fullWidth { max-width: none; padding: 0 var(--p-space-4); }

.Polaris-Frame-ContextualSaveBar__Message { overflow: hidden; white-space: nowrap; text-overflow: ellipsis; font-size: var(--p-font-size-6); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-3); color: var(--p-text-subdued); }

@media (min-width: 40em) { .Polaris-Frame-ContextualSaveBar__Message { font-size: var(--p-font-size-5); } }
...
@media (min-width: 48.0625em) { .Polaris-Frame-ContextualSaveBar__ContextControl { display: block; width: 15rem; } }
...
@media (min-width: 48.0625em) { .Polaris-Frame { width: calc(100% - var(--pc-frame-offset)); margin-left: var(--pc-frame-offset); } }
...
@media (min-width: 48.0625em) { .Polaris-Frame__Navigation { z-index: 1; left: var(--pc-frame-offset); display: flex; }
...
@media (min-width: 48.0625em) { .Polaris-Frame__TopBar { left: var(--pc-frame-offset); width: calc(100% - var(--pc-frame-offset)); } }

.Polaris-Frame__ContextualSaveBar { position: fixed; z-index: var(--p-z-5); top: 0; left: 0; width: 100%; }

@media (min-width: 48.0625em) { .Polaris-Frame__ContextualSaveBar { left: var(--pc-frame-offset); width: calc(100% - var(--pc-frame-offset)); } }
...
@media (min-width: 48.0625em) { .Polaris-Frame--hasNav .Polaris-Frame__Main { padding-left: 15rem; padding-left: 240px; padding-left: calc(15rem + constant(safe-area-inset-left)); padding-left: calc(15rem + env(safe-area-inset-left)); } }
...
@media (min-width: 48.0625em) { .Polaris-Frame__GlobalRibbonContainer { left: var(--pc-frame-offset); }
...
@media (min-width: 48.0625em) { .Polaris-Frame--hasNav .Polaris-Frame__LoadingBar { left: var(--pc-frame-offset); }
...
.Polaris-Frame__Skip > a { position: relative; position: relative; display: inline-flex; align-items: center; justify-content: center; min-height: var(--p-line-height-6); min-width: var(--p-line-height-6); margin: 0; padding: calc((var(--p-line-height-6) - var(--p-line-height-2) - var(--p-space-05))/2) var(--p-space-4); background: var(--p-surface); box-shadow: var(--p-shadow-button); border-radius: var(--p-border-radius-1); color: var(--p-text); border: 0.0625rem solid var(--p-border-neutral-subdued); border-top-color: var(--p-border-subdued); border-bottom-color: var(--p-border-shadow-subdued); line-height: 1; text-align: center; cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; -webkit-tap-highlight-color: transparent; font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-medium); line-height: var(--p-line-height-1); text-transform: initial; letter-spacing: initial; position: relative; color: var(--p-text); }
...
@media (-ms-high-contrast: active) { .Polaris-Frame__Skip > a { border: 0.0625rem solid windowText; } }

@media (min-width: 40em) { .Polaris-Frame__Skip > a { font-size: var(--p-font-size-3); } }
...
.Polaris-IndexTable { --pc-index-table-translate-offset: calc(3.125rem - var(--p-space-4)); --pc-index-table-table-header-offset: 3.25rem; --pc-index-table-cell: 1; --pc-index-table-sticky-cell: 31; --pc-index-table-scroll-bar: 35; --pc-index-table-bulk-actions: 36; --pc-index-table-loading-panel: 37; position: relative; overflow: hidden; border-radius: inherit; }
...
@media (min-width: 28.625em) { .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second { filter: drop-shadow(0.0625rem 0 0 var(--p-divider)); } }

.Polaris-IndexTable__Table--scrolling.Polaris-IndexTable__Table--unselectable .Polaris-IndexTable__TableHeading--second, .Polaris-IndexTable__Table--scrolling.Polaris-IndexTable__Table--unselectable .Polaris-IndexTable__TableCell:first-child { visibility: visible; filter: drop-shadow(0.0625rem 0 0 var(--p-divider)); }
...
.Polaris-IndexTable__TableHeading { padding: var(--p-space-4); text-align: left; font-weight: var(--p-font-weight-medium); white-space: nowrap; border: 0; }

.Polaris-IndexTable__TableHeading--first { --pc-index-table-checkbox-offset-left: 0.875rem; --pc-index-table-checkbox-offset-right: 1.125rem; position: sticky; left: 0; padding-left: var(--pc-index-table-checkbox-offset-left); padding-right: var(--pc-index-table-checkbox-offset-right); }
...
.Polaris-IndexTable__TableCell--first { position: sticky; left: 0; z-index: var(--pc-index-table-sticky-cell); padding: 0; }

.Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { left: var(--pc-checkbox-offset); padding-left: 0; }

@media (min-width: 28.625em) { .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { position: sticky; z-index: var(--pc-index-table-sticky-cell); padding: 0; } }

.Polaris-IndexTable__Table--unselectable .Polaris-IndexTable__TableCell:first-child { left: 0; background-color: var(--p-surface); position: sticky; z-index: var(--pc-index-table-sticky-cell); }
...
@media (min-width: 28.625em) { .Polaris-IndexTable--tableStickyScrolling .Polaris-IndexTable__TableCell:last-child, .Polaris-IndexTable--tableStickyScrolling .Polaris-IndexTable__TableHeading--last { filter: drop-shadow(-0.0625rem 0 0 var(--p-border-divider)); } }

@media (min-width: 28.625em) { .Polaris-IndexTable--tableStickyLast .Polaris-IndexTable__TableCell:last-child { position: sticky; right: 0; background-color: var(--p-surface); z-index: var(--pc-index-table-sticky-cell); } }
...
.Polaris-IndexTable__ScrollBarContainer { position: sticky; z-index: var(--pc-index-table-scroll-bar); bottom: 0; padding: var(--p-space-05); border-top: var(--p-border-divider); background-color: var(--p-surface); border-bottom-right-radius: var(--p-border-radius-1); border-bottom-left-radius: var(--p-border-radius-1); }
...
.Polaris-IndexTable__HeaderWrapper { position: relative; display: flex; align-items: flex-start; width: 100%; min-height: 3.5rem; padding: 0.625rem var(--p-space-4); background-color: var(--p-surface); }
...
.Polaris-IndexTable-Checkbox--expanded { width: 2rem; height: 2rem; padding-left: var(--p-space-4); }
...
.Polaris-KeyboardKey { display: inline-block; height: 1.5rem; margin: 0 var(--p-space-05) var(--p-space-05); padding: 0 var(--p-space-1); background-color: var(--p-surface); box-shadow: 0 0 0 0.0625rem var(--p-border-subdued), 0 var(--p-space-05) 0 0 var(--p-surface), 0 var(--p-space-05) 0 0.0625rem var(--p-border-subdued); border-radius: var(--p-border-radius-1); font-family: var(--p-font-family-sans); font-size: var(--p-font-size-1); font-weight: var(--p-font-weight-medium); line-height: 1.5rem; color: var(--p-text-subdued); text-align: center; min-width: 1.5rem; -webkit-user-select: none; user-select: none; }
...
@media print { body .Polaris-Layout { font-size: var(--p-font-size-1); line-height: var(--p-line-height-1); }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Layout__Section + .Polaris-Layout__AnnotatedSection, [data-has-navigation] .Polaris-Layout__AnnotatedSection + .Polaris-Layout__AnnotatedSection { padding-top: var(--p-space-4); border-top: var(--p-border-divider); } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Layout__Annotation { padding: var(--p-space-4) 0 0; } }

@media (min-width: 30.625em) { .Polaris-Layout__Annotation { padding: var(--p-space-4) 0 0; } }

@media (max-width: 48.0625em) and (min-width: 50em), (min-width: 65em) { [data-has-navigation] .Polaris-Layout__Annotation { padding: var(--p-space-5) var(--p-space-5) var(--p-space-5) 0; } }

@media (min-width: 50em) { .Polaris-Layout__Annotation { padding: var(--p-space-5) var(--p-space-5) var(--p-space-5) 0; } }
...
.Polaris-Link:focus:not(:active) { outline: var(--p-focused) auto 0.0625rem; }
...
.Polaris-MediaCard__MediaContainer { overflow: hidden; border-top-left-radius: var(--p-border-radius-2); border-top-right-radius: var(--p-border-radius-2); }
...
@media (min-width: 50.25em) { .Polaris-MediaCard__MediaContainer:not(.Polaris-MediaCard--portrait) { border-top-right-radius: 0; border-top-left-radius: var(--p-border-radius-2); border-bottom-left-radius: var(--p-border-radius-2); } }
...
@media (max-width: 50.25em) { .Polaris-MediaCard__ActionContainer { padding-top: var(--p-space-8); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation { max-width: 15rem; max-width: 240px; max-width: calc(15rem + constant(safe-area-inset-left)); max-width: calc(15rem + env(safe-area-inset-left)); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__PrimaryNavigation { padding-top: var(--p-space-4); } }

.Polaris-Navigation__LogoContainer { display: none; }

@media (max-width: 48.0525em) { .Polaris-Navigation__LogoContainer { display: flex; flex: 0 0 3.5rem; align-items: center; height: 3.5rem; padding: 0 var(--p-space-2) 0 var(--p-space-4); flex-basis: 3.5rem; flex-basis: calc(3.5rem + constant(safe-area-inset-left)); flex-basis: calc(3.5rem + env(safe-area-inset-left)); padding-left: var(--p-space-4); padding-left: calc(var(--p-space-4) + constant(safe-area-inset-left)); padding-left: calc(var(--p-space-4) + env(safe-area-inset-left)); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__Item { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-medium); line-height: var(--p-line-height-5); padding-left: var(--p-space-3); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__Item--selected { font-weight: var(--p-font-weight-medium); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__Badge { margin-top: var(--p-space-1); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__Icon { margin-top: var(--p-space-1); margin-right: var(--p-space-2); margin-bottom: var(--p-space-1); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__ExternalIcon { height: 2rem; } }
...
.Polaris-Navigation__ListItem:not(:first-child) .Polaris-Navigation__Item { border-top: 0.0625rem solid var(--p-background); }
...
.Polaris-Navigation__Text { flex: 1 1 auto; margin-top: calc(var(--p-space-2) + var(--p-space-05)); margin-bottom: calc(var(--p-space-2) + var(--p-space-05)); line-height: var(--p-line-height-2); font-size: var(--p-font-size-3); }

@media (min-width: 48.0625em) { .Polaris-Navigation__Text { margin-top: var(--p-space-1); margin-bottom: var(--p-space-1); } }

@media (max-width: 48.0625em) { .Polaris-Navigation__Text { font-size: var(--p-font-size-4); line-height: var(--p-line-height-2); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__SecondaryAction { height: 2rem; } }
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item { font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-medium); line-height: 2.5rem; color: var(--p-text-subdued); padding-left: calc(var(--p-space-8) + var(--p-space-3)); }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item { font-size: var(--p-font-size-3); line-height: 1; padding-left: var(--p-space-10); } }
...
.Polaris-Navigation__SectionHeading { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; text-transform: none; display: flex; align-items: center; padding-left: calc(var(--p-space-5) + var(--p-space-05)); }

@media (min-width: 40em) { .Polaris-Navigation__SectionHeading { font-size: var(--p-font-size-1); } }

.Polaris-Navigation__SectionHeading .Polaris-Navigation__Text { font-size: var(--p-font-size-2); color: var(--p-text-subdued); }

@media (min-width: 40em) { .Polaris-Navigation__SectionHeading .Polaris-Navigation__Text { font-size: var(--p-font-size-1); } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__SectionHeading .Polaris-Navigation__Action svg, .Polaris-Navigation__SectionHeading .Polaris-Navigation__Action img { height: var(--p-space-4); width: var(--p-space-4); margin: var(--p-space-05); } }
...
.Polaris-OptionList-Checkbox__Input { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-OptionList__Title { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; padding: var(--p-space-2); color: var(--p-text-subdued); }

@media (min-width: 40em) { .Polaris-OptionList__Title { font-size: var(--p-font-size-1); } }
...
.Polaris-Header-Title { word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; font-weight: var(--p-font-weight-semibold); font-size: var(--p-font-size-9); line-height: var(--p-line-height-4); }

@media (min-width: 40em) { .Polaris-Header-Title { font-size: var(--p-font-size-7); } }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-Page-Header { padding: var(--p-space-5) 0; } }

@media (min-width: 46.5em) { .Polaris-Page-Header { padding: var(--p-space-5) 0; } }

.Polaris-Page-Header--titleHidden { position: absolute !important; top: 0; width: 0.0625rem !important; height: 0.0625rem !important; margin: 0 !important; padding: 0 !important; overflow: hidden !important; -webkit-clip-path: inset(50%) !important; clip-path: inset(50%) !important; border: 0 !important; white-space: nowrap !important; }
...
.Polaris-Page-Header__PaginationWrapper button { border: 0.0625rem solid var(--p-border-neutral-subdued) !important; box-shadow: none !important; }

.Polaris-Page-Header__PaginationWrapper button:hover, .Polaris-Page-Header__PaginationWrapper button:active, .Polaris-Page-Header__PaginationWrapper button:focus { border: 0.0625rem solid var(--p-border-neutral-subdued) !important; }
...
.Polaris-Page-Header--mobileView .Polaris-Page-Header__ActionMenuWrapper { position: absolute; top: calc(var(--p-space-5) + 0.5625rem); right: var(--p-space-5); margin-top: 0; }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Page-Header--mobileView .Polaris-Page-Header__ActionMenuWrapper { right: calc((var(--p-space-2))*-1); } }

@media (min-width: 30.625em) { .Polaris-Page-Header--mobileView .Polaris-Page-Header__ActionMenuWrapper { right: calc((var(--p-space-2))*-1); } }

.Polaris-Page-Header--mobileView.Polaris-Page-Header--hasNavigation .Polaris-Page-Header__ActionMenuWrapper { top: 1.125rem; }
...
@media (min-width: 29.25em) { .Polaris-Page-Header__AdditionalMetaData { margin-left: calc(var(--p-space-5)*2 + var(--p-space-2) + var(--p-space-1)); } }
...
@media (min-width: 48.0625em) { .Polaris-Page-Header--mediumTitle.Polaris-Page-Header--noBreadcrumbs .Polaris-Page-Header__RightAlign { margin-bottom: 0; } }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Page { padding: 0 var(--p-space-6); } }
...
.Polaris-Page__Content { margin: var(--p-space-2) 0; }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-Page__Content { margin-top: var(--p-space-5); } }

@media (min-width: 46.5em) { .Polaris-Page__Content { margin-top: var(--p-space-5); } }

.Polaris-Page--divider { border-top: var(--p-border-divider); padding-top: var(--p-space-4); }


.Polaris-PageActions { margin: 0 auto; padding: var(--p-space-5); border-top: var(--p-border-divider); }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-PageActions { padding: var(--p-space-5) 0; } }
...
.Polaris-RangeSlider-DualThumb__Thumbs::after { content: ''; position: absolute; z-index: 1; top: calc(var(--p-border-width-1)*-1 + -0.0625rem); right: calc(var(--p-border-width-1)*-1 + -0.0625rem); bottom: calc(var(--p-border-width-1)*-1 + -0.0625rem); left: calc(var(--p-border-width-1)*-1 + -0.0625rem); display: block; pointer-events: none; box-shadow: 0 0 0 calc(var(--p-border-width-1)*-1 + -0.0625rem) var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: calc(var(--p-border-radius-2) + 0.0625rem); }
...
.Polaris-RangeSlider-SingleThumb__OutputText { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-semibold); line-height: var(--p-line-height-1); text-transform: uppercase; display: block; flex: 1 1 auto; margin: auto; text-align: center; color: var(--p-text); }

@media (min-width: 40em) { .Polaris-RangeSlider-SingleThumb__OutputText { font-size: var(--p-font-size-1); } }


.Polaris-ResourceItem__CheckboxWrapper { display: flex; }

.Polaris-ResourceItem { --pc-resource-item-offset: calc(2.25rem + var(--p-space-1)); position: relative; outline: none; cursor: pointer; }
...
.Polaris-ResourceItem__Container { position: relative; z-index: 2; padding: var(--p-space-3) var(--p-space-4); min-height: 2.75rem; display: flex; align-items: flex-start; }

@media (min-width: 28.625em) { .Polaris-ResourceItem__Container { padding: var(--p-space-3) var(--p-space-5); } }
...
.Polaris-ResourceItem__Handle { width: 3rem; min-height: 2.75rem; justify-content: center; align-items: center; margin: calc(var(--p-space-3)*-1) var(--p-space-1) calc(var(--p-space-3)*-1) calc(var(--p-space-3)*-1); display: flex; }
...
.Polaris-ResourceItem__Disclosure { position: relative; top: calc(var(--p-space-3)*-1); right: calc(var(--p-space-4)*-1); display: none; width: 3rem; min-height: 2.75rem; pointer-events: initial; }

.Polaris-ResourceItem--selectMode .Polaris-ResourceItem__Disclosure { display: none; }

@media (max-width: 45em), (min-width: 48.0625em) and (max-width: 61.5em) { [data-has-navigation] .Polaris-ResourceItem__Disclosure { display: flex; flex: 0 0 3rem; justify-content: center; align-items: center; } }

@media (max-width: 46.5em) { .Polaris-ResourceItem__Disclosure { display: flex; flex: 0 0 3rem; justify-content: center; align-items: center; } }
...
@media (min-width: 40em) { .Polaris-Select__Content { font-size: var(--p-font-size-3); } }
...
.Polaris-Select__Input { font-size: var(--p-font-size-5); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-3); border: none; text-transform: initial; letter-spacing: initial; position: absolute; text-rendering: auto; top: 0; left: 0; z-index: var(--pc-select-input); width: 100%; height: 100%; margin: 0; opacity: 0; -webkit-appearance: none; appearance: none; }

@media (min-width: 40em) { .Polaris-Select__Input { font-size: var(--p-font-size-3); } }
...
@media (min-width: 28.625em) { .Polaris-ResourceList__FiltersWrapper { padding: var(--p-space-4); } }
...
@media (min-width: 28.625em) { .Polaris-ResourceList__HeaderWrapper { flex-direction: row; } }
...
@media (min-width: 28.625em) { .Polaris-ResourceList__HeaderContentWrapper { right: var(--p-space-4); left: var(--p-space-4); align-self: flex-start; } }
...
@media (min-width: 28.625em) { .Polaris-ResourceList__SortWrapper, .Polaris-ResourceList__AlternateToolWrapper { position: relative; left: auto; flex: 0 1 auto; margin-left: var(--p-space-4); }
...
.Polaris-SkeletonBodyText { height: var(--p-space-2); position: relative; }

.Polaris-SkeletonBodyText::after { content: ''; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: block; background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-base); }
...
.Polaris-SkeletonDisplayText__DisplayText { --pc-skeleton-display-text-height: var(--p-line-height-2); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-2); max-width: 7.5rem; position: relative; }

.Polaris-SkeletonDisplayText__DisplayText::after { content: ''; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: block; background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-base); }

@media screen and (-ms-high-contrast: active) { .Polaris-SkeletonDisplayText__DisplayText::after { background-color: grayText; } }

.Polaris-SkeletonDisplayText--sizeSmall { --pc-skeleton-display-text-height: var(--p-line-height-3); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-4); height: var(--pc-skeleton-display-text-height); }

@media (min-width: 40em) { .Polaris-SkeletonDisplayText--sizeSmall { height: var(--pc-skeleton-display-text-height-not-condensed); } }

.Polaris-SkeletonDisplayText--sizeMedium { --pc-skeleton-display-text-height: var(--p-line-height-4); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-5); height: var(--pc-skeleton-display-text-height); }

@media (min-width: 40em) { .Polaris-SkeletonDisplayText--sizeMedium { height: var(--pc-skeleton-display-text-height-not-condensed); } }

.Polaris-SkeletonDisplayText--sizeLarge { --pc-skeleton-display-text-height: var(--p-line-height-4); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-5); height: var(--pc-skeleton-display-text-height); }

@media (min-width: 40em) { .Polaris-SkeletonDisplayText--sizeLarge { height: var(--pc-skeleton-display-text-height-not-condensed); } }

.Polaris-SkeletonDisplayText--sizeExtraLarge { --pc-skeleton-display-text-height: var(--p-line-height-6); --pc-skeleton-display-text-height-not-condensed: var(--p-line-height-7); height: var(--pc-skeleton-display-text-height); }

@media (min-width: 40em) { .Polaris-SkeletonDisplayText--sizeExtraLarge { height: var(--pc-skeleton-display-text-height-not-condensed); } }


.Polaris-SkeletonPage__Page { margin: 0 auto; padding: 0; max-width: 62.375rem; }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-SkeletonPage__Page { padding: 0 var(--p-space-6); } }
...
.Polaris-SkeletonPage__Content { margin: var(--p-space-2) 0; }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-SkeletonPage__Content { margin-top: var(--p-space-5); } }

@media (min-width: 46.5em) { .Polaris-SkeletonPage__Content { margin-top: var(--p-space-5); } }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-SkeletonPage__Header { padding: var(--p-space-5) 0; } }

@media (min-width: 46.5em) { .Polaris-SkeletonPage__Header { padding: var(--p-space-5) 0; } }
...
@media (min-width: 40em) { .Polaris-SkeletonPage__Title { font-size: 1.25rem; } }

.Polaris-SkeletonPage__SkeletonTitle { position: relative; max-width: 7.5rem; height: 1.75rem; }

.Polaris-SkeletonPage__SkeletonTitle::after { content: ''; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: block; background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-base); }
...
@media (max-width: 48.0625em), (min-width: 48.0625em) and (max-width: 65em) { [data-has-navigation] .Polaris-SkeletonPage__PrimaryAction { margin-top: var(--p-space-4); margin-bottom: calc(var(--p-space-2)*-1); } }

@media (max-width: 50em) { .Polaris-SkeletonPage__PrimaryAction { margin-top: var(--p-space-4); margin-bottom: calc(var(--p-space-2)*-1); } }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-SkeletonPage__PrimaryAction { margin-top: var(--p-space-2); margin-bottom: calc(var(--p-space-2)*-1); } }
...
.Polaris-SkeletonTabs__Tab { position: relative; padding: calc(var(--p-space-5) + var(--p-border-width-2)) var(--p-space-4); }
...
.Polaris-SkeletonThumbnail { position: relative; }

.Polaris-SkeletonThumbnail::after { content: ''; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: block; background-color: var(--p-surface-neutral); border-radius: var(--p-border-radius-base); }

@media screen and (-ms-high-contrast: active) { .Polaris-SkeletonThumbnail::after { background-color: grayText; } }

.Polaris-SkeletonThumbnail--sizeSmall { height: 2.5rem; width: 2.5rem; }

.Polaris-SkeletonThumbnail--sizeMedium { height: 3.75rem; width: 3.75rem; }

.Polaris-SkeletonThumbnail--sizeLarge { height: 5rem; width: 5rem; }
...
.Polaris-Tabs__Tab { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; font-size: var(--p-font-size-4); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); text-transform: initial; letter-spacing: initial; color: var(--p-text-subdued); color: var(--p-text); position: relative; justify-content: center; width: 100%; min-width: 100%; margin-top: 0.0625rem; margin-bottom: -0.0625rem; padding: var(--p-space-2) var(--p-space-1); outline: none; text-align: center; white-space: nowrap; text-decoration: none; cursor: pointer; }

.Polaris-Tabs__Tab:focus { outline: none; }

@media (min-width: 40em) { .Polaris-Tabs__Tab { font-size: var(--p-font-size-3); } }
...
.Polaris-Tabs__DisclosureActivator { position: relative; height: 100%; background-color: transparent; cursor: pointer; border: none; outline: none; margin: 0.0625rem 0.0625rem -0.0625rem 0; }
...
.Polaris-Thumbnail { position: relative; display: block; overflow: hidden; background: var(--p-surface); min-width: 2.5rem; max-width: 100%; border-radius: var(--p-border-radius-1); border: var(--p-border-divider); }

.Polaris-Thumbnail::after { content: ''; display: block; padding-bottom: 100%; }

.Polaris-Thumbnail--sizeSmall { width: 2.5rem; }

.Polaris-Thumbnail--sizeMedium { width: 3.75rem; }

.Polaris-Thumbnail--sizeLarge { width: 5rem; }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-TopBar-Search { position: absolute; top: 100%; max-width: 36.25rem; margin: var(--p-space-1) var(--p-space-5) 0; border-radius: var(--p-border-radius-2); } }
...
@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-TopBar-Search { margin: var(--p-space-1) var(--p-space-8) 0; } }

@media (min-width: 46.5em) { .Polaris-TopBar-Search { margin: var(--p-space-1) var(--p-space-8) 0; } }
...
@media (min-width: 40em) { .Polaris-TopBar-SearchField__Input { font-size: var(--p-font-size-3); } }
...
.Polaris-MessageIndicator { position: absolute; z-index: 1; top: -0.1875rem; right: -0.1875rem; width: 0.75rem; height: 0.75rem; border-radius: var(--p-border-radius-half); background-color: var(--p-icon-highlight); border: solid 0.125rem var(--p-background); }
...
@media (min-width: 40em) { .Polaris-TopBar-UserMenu__Name { font-size: var(--p-font-size-3); } }

.Polaris-TopBar-UserMenu__Detail { font-size: var(--p-font-size-2); font-weight: var(--p-font-weight-regular); line-height: var(--p-line-height-2); overflow: hidden; white-space: nowrap; text-overflow: ellipsis; opacity: 0.7; color: var(--p-text); text-align: left; }

@media (min-width: 40em) { .Polaris-TopBar-UserMenu__Detail { font-size: var(--p-font-size-1); line-height: var(--p-line-height-1); } }
...
.Polaris-TopBar::after { content: ''; position: absolute; bottom: 0; width: 100%; border-bottom: 0.0625rem solid transparent; }
...
@media (min-width: 48.0625em) { .Polaris-TopBar__ContextControl { width: 15rem; display: block; } }

@media (min-width: 87.5em) { .Polaris-TopBar__ContextControl { width: 15rem; } }
...
.Polaris-TopBar__SearchField { margin: 0 auto; padding: 0; max-width: 62.375rem; position: relative; width: 100%; margin: 0; max-width: none; margin-left: calc(50% - 31.1875rem); }

@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-TopBar__SearchField { padding: 0 var(--p-space-6); } }

@media (min-width: 30.625em) { .Polaris-TopBar__SearchField { padding: 0 var(--p-space-6); } }

@media (max-width: 1238px) { .Polaris-TopBar__SearchField { margin-left: 0; margin-right: var(--p-space-1); } }
