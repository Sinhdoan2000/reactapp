...
export declare function Listbox({ children, autoSelection, enableKeyboardControl, accessibilityLabel, onSelect, onActiveOptionChange, }: ListboxProps): JSX.Element;
