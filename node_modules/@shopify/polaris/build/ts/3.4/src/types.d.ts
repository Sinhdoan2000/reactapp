...
export declare type Descriptor = SectionDescriptor | OptionDescriptor;
...
export interface ComplexAction extends Action, DisableableAction, DestructableAction, IconableAction, OutlineableAction, LoadableAction, PlainAction {
}
