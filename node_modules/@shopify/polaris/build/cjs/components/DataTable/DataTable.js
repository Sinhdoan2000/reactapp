...
class DataTableInner extends React.PureComponent {
  ...
  render() {
    ...
    const wrapperClassName = css.classNames(DataTable$1['default'].TableWrapper, condensed && DataTable$1['default'].condensed, increasedTableDensity && DataTable$1['default'].IncreasedTableDensity);
