...
function Badge({
  ...
  const className = css.classNames(Badge$1['default'].Badge, status && Badge$1['default'][css.variationName('status', status)], icon && Badge$1['default'].icon, size && size !== DEFAULT_SIZE && Badge$1['default'][css.variationName('size', size)], withinFilter && Badge$1['default'].withinFilter);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && /*#__PURE__*/React__default['default'].createElement(VisuallyHidden.VisuallyHidden, null, accessibilityLabel);
